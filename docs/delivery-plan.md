...
Статус: **выполнен; автоматизированный релиз 1.2.2 опубликован**
Дата: 2026-09-08  
Репозиторий назначения: `hokoo/wp-site-options`

План утверждён владельцем 2026-09-08; execution batch и production release
затем были отдельно одобрены и выполнены. E1-E6 завершены: GitHub является
каноническим source, а версия `1.2.2` опубликована через проверенный tag-driven
процесс в GitHub и WordPress.org.
